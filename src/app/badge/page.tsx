...
const BADGES: Badge[] = [
  ...
  // ── Training ────────────────────────────────────────────────────────────
  {
    ...
    icon: "🥷",
    name: "First Lesson",
    description: "Equipped your first shell from a certified provider.",
    category: "training",
    rarity: "common",
    earned: true,
    earnedAt: "2026-03-14",
    requirement: "Equip 1 shell",
    holders: 9654,
    xp: 150,
  },
  {
    ...
    icon: "📚",
    name: "Study Hard",
    description: "Logged 10 hours of cumulative shell session time.",
    category: "training",
    rarity: "uncommon",
    earned: false,
    progress: 72,
    requirement: "10 shell hours total",
    holders: 2201,
    xp: 600,
  },
  {
    ...
    icon: "🎓",
    name: "Valedictorian",
    description: "Received a perfect 5/5 rating from a Tier-S shell provider.",
    category: "training",
    rarity: "rare",
    earned: false,
    requirement: "5/5 rating from Tier-S provider",
    holders: 512,
    xp: 1500,
    maiatBoost: 5,
  },
  ...
  },
  {
    ...
    icon: "🔥",
    name: "7-Day Streak",
    description: "Equipped shells every day for a full week. Consistency is the edge.",
    category: "training",
    rarity: "uncommon",
    earned: true,
    earnedAt: "2026-03-20",
    requirement: "7-day consecutive shell usage",
    holders: 3814,
    xp: 700,
    maiatBoost: 3,
  },
  ...
  },
  {
    ...
    description: "Became a registered shell provider and completed your first session.",
    category: "community",
    rarity: "rare",
    earned: false,
    requirement: "Register as shell provider + 1 session",
    holders: 441,
    xp: 2000,
    maiatBoost: 5,
  },
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <header className="mb-8">
          ...
          <p className="text-sm text-[var(--muted)] max-w-xl">
            Achievements earned through assessment, shell sessions, and combat. Every badge is on-chain verifiable and contributes to your Maiat trust score.
          </p>
        </header>
